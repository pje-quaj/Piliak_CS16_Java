...
{ 
    ...
    public lab2(ReentrantLock lk_param)
    {
        lk = lk_param;
    }
...
class lab4 extends JPanel implements ActionListener, Runnable
{
    ...
    public lab4(ReentrantLock lk_param)
    {
        this.setLayout(null);
...
public class Lab3_Lock
{
    ...
    {        
        ...
        lab2 thread_lab2 = new lab2(LK);
        lab4 thread_lab4 = new lab4(LK);
